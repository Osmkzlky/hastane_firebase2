...
class DuyuruKayit extends StatefulWidget {
  const DuyuruKayit({super.key});

  @override
  State<DuyuruKayit> createState() => _DuyuruKayitState();
}

class _DuyuruKayitState extends State<DuyuruKayit> {
                  ...
                  SizedBox(
                    ...
                    child: Padding(
                      ...
                      child: ElevatedButton(
                          onPressed: () {
                            context.read<DuyuruKayitCubit>().kaydet(tfBaslik.text, tfAciklama.text, tfTarih.text);
                          },
